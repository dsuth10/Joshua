...
const doc = new Document({
    ...
    sections: [{
        children: [
            ...
            new Paragraph({ children: [new TextRun("B. An annotated diagram includes explanations.")] }),
            ...
            new Paragraph({ children: [new TextRun("B. The emergency response to Cyclone Tracy.")] }),
            ...
            new Paragraph({ spacing: { before: 200 }, children: [new TextRun("10. Why is a risk assessment necessary before a science investigation?")] }),
            new Paragraph({ children: [new TextRun("A. To get a better grade.")] }),
            new Paragraph({ children: [new TextRun("B. To identify potential hazards and keep everyone safe.")] }),
            new Paragraph({ children: [new TextRun("C. Because the teacher said so.")] }),
            new Paragraph({ children: [new TextRun("D. To waste time.")] }),
            new Paragraph({ children: [new TextRun("ANSWER: B")] }),
            new Paragraph({ children: [new TextRun("POINT: 1")] })
        ]
    }]
