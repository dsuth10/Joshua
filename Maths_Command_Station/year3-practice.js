...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof MCS !== 'undefined' && MCS.focusedSession) {
        MCS.focusedSession.renderDashboard('dashboard-strands-container', 3, profile, (badgeId) => {
        ...
        backBtn.addEventListener('click', () => {
            if (state.descriptorSession) {
                MCS.focusedSession.exit(state, false, {
                    onExit: () => {
                        MCS.focusedSession.renderDashboard('dashboard-strands-container', 3, profile);
