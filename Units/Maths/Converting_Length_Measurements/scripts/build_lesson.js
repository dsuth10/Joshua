      ...
      standardHtml: `
        <div style="display:grid; grid-template-columns: repeat(2, 1fr); gap:20px; margin-top:20px;">
          <div style="background:#e3f2fd; border-left:8px solid #1e88e5; padding:20px; border-radius:8px; box-shadow:var(--shadow-sm);">
            ...
            <p style="font-size:22px; line-height:1.4;">Used for tiny things. Think of the thickness of a small coin or a pencil lead. <br><strong>10 mm = 1 cm</strong></p>
          </div>
          <div style="background:#fff3e0; border-left:8px solid #fb8c00; padding:20px; border-radius:8px; box-shadow:var(--shadow-sm);">
            ...
            <p style="font-size:22px; line-height:1.4;">Used for everyday items. Think of the length of a pen or the width of a phone. <br><strong>100 cm = 1 m</strong></p>
          </div>
          <div style="background:#e8f5e9; border-left:8px solid #4caf50; padding:20px; border-radius:8px; box-shadow:var(--shadow-sm);">
            ...
            <p style="font-size:22px; line-height:1.4;">Used for larger scale spaces. Think of classroom height or the width of a street. <br><strong>1000 m = 1 km</strong></p>
          </div>
        ...
        <div style="display:flex; gap:30px; align-items:center; margin-top:20px;">
          <div style="flex:1;">
            ...
            <div style="background:#eef2f6; padding:20px; border-radius:6px; margin-top:20px; font-size:24px;">
              ...
              • 34 mm &rarr; 34 &divide; 10 = <strong>3.4 cm</strong><br>
              • 26 mm &rarr; 26 &divide; 10 = <strong>2.6 cm</strong>
            </div>
          </div>
          <div style="width:300px; background:#fff3e0; border:2px solid var(--orange); border-radius:12px; padding:24px; text-align:center; box-shadow:var(--shadow-md);">
            ...
            <p style="font-size:20px; margin-top:10px; line-height:1.4;">"Just like the king says, 34 mm splits into 3.4 cm!"</p>
            <div style="background:var(--navy); color:#fff; border-radius:6px; padding:10px; margin-top:15px; font-weight:bold; font-size:22px;">34 &divide; 10 = 3.4</div>
          </div>
        </div>
      `,
      teacherNotes: `
      ...
      standardHtml: `
        ...
        <div class="match-container" id="slide-6-match">
          ...
          <div class="hint-box" id="slide-6-hint">
            <strong>Hint:</strong> Remember, divide by 10. E.g., 49 &divide; 10 = 4.9.
          </div>
        </div>
      ...
      standardHtml: `
        <div style="display:flex; gap:30px; align-items:center; margin-top:20px;">
          <div style="flex:1;">
            ...
            <div style="background:#eef2f6; padding:20px; border-radius:6px; margin-top:20px; font-size:24px;">
              <strong>Examples:</strong><br>
              • 251 cm &rarr; 251 &divide; 100 = <strong>2.51 m</strong><br>
              • 829 cm &rarr; 829 &divide; 100 = <strong>8.29 m</strong><br>
              • 1165 cm &rarr; 1165 &divide; 100 = <strong>11.65 m</strong>
            </div>
          </div>
          <div style="width:300px; background:#e3f2fd; border:2px solid var(--blue); border-radius:12px; padding:24px; text-align:center; box-shadow:var(--shadow-md);">
            ...
            <div style="background:var(--navy); color:#fff; border-radius:6px; padding:10px; margin-top:15px; font-weight:bold; font-size:22px;">100 cm = 1 m</div>
          </div>
        </div>
      `,
      teacherNotes: `
      ...
      standardHtml: `
        <div style="display:flex; gap:30px; align-items:center; margin-top:20px;">
          <div style="flex:1;">
            ...
            <div style="background:#eef2f6; padding:20px; border-radius:6px; margin-top:20px; font-size:24px;">
              <strong>Examples:</strong><br>
              • 3.16 m &rarr; 3.16 &times; 100 = <strong>316 cm</strong><br>
              • 9.54 m &rarr; 9.54 &times; 100 = <strong>954 cm</strong><br>
              • 10.75 m &rarr; 10.75 &times; 100 = <strong>1075 cm</strong>
            </div>
          </div>
          <div style="width:300px; background:#fff9db; border:2px solid #fcc419; border-radius:12px; padding:24px; text-align:center; box-shadow:var(--shadow-md);">
            ...
            <div style="background:var(--navy); color:#fff; border-radius:6px; padding:10px; margin-top:15px; font-weight:bold; font-size:22px;">&times; 100</div>
          </div>
        </div>
      `,
      teacherNotes: `
      ...
      standardHtml: `
        <div style="max-width:800px; margin:0 auto; text-align:left;">
          ...
          <div style="background:rgba(255,255,255,0.1); padding:25px; border-radius:8px; font-size:24px; line-height:1.8;">
            1. Convert 64 mm to centimetres: __________ cm<br>
            2. Convert 1021 cm to metres: __________ m<br>
            3. Convert 2.95 m to centimetres: __________ cm
          </div>
        </div>
      `,
      teacherNotes: `
