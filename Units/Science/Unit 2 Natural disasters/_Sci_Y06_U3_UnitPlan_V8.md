...
- Resources/Documents/Sci_Y06_U3_SH_Volcanoes.docx
...
- Resources/Documents/Sci_Y06_U3_SLR_EarthquakesBePrepared.pdf
...
- Resources/Video/Sci_Y06_U3_MountStHelens.mp4
- Resources/Video/Sci_Y06_U3_tropicalcyclones.mp4
- Resources/Video/Sci_Y06_U3_MountStHelens.mp4
- Resources/Video/Sci_Y06_U3_EarthquakeMemories.mp4
- Resources/Documents/Sci_Y06_U3_SLR_EarthquakesBePrepared.pdf
- Resources/Documents/Sci_Y06_U3_SH_TheSea.docx
...
Status
Date
Analysing evidence using the Beaufort wind scale (Yr 06)
Monitoring
Science
Unscheduled
Students explain that wind speed cannot always be measured directly, but can be determined by the effects of the wind, identify and examine the use of the Beaufort wind scale to report wind speeds and explore how only the maximum wind speed can be recorded after the event, but images taken during the event can indicate the wind speed at different stages of the event and identify limitations of the Beaufort wind scale.
Examining the effects of earthquakes (Yr 06)
Monitoring
Science
Unscheduled
Students list evidence that may indicate an earthquake has taken place, discuss the use of a seismograph as a device to collect data about an earthquake, explain how knowledge of earthquake activity can be used by communities and describe changes to Earth\'s surface that are caused by earthquakes.
Explaining changes to the surface of Earth (Yr 06)
Exam/Test
Science
Unscheduled
...
Using Asian indigenous knowledge to prepare for disaster (Yr 06)
Monitoring
Science
Unscheduled
Students explain how stories told in different cultures allow for knowledge of natural disasters to be shared and describe how these stories improve the community\'s preparedness for natural disasters.
...
- Attachments
- Exam/Test - Explaining changes to the surface of Earth (Yr 06)
- Considerations
- Geological events
- Plan Resource Bank
- Monitoring - Analysing evidence using the Beaufort wind scale (Yr 06)
- Meteorological events
- Monitoring - Examining the effects of earthquakes (Yr 06)
- Weather measurement
- Monitoring - Using Asian indigenous knowledge to prepare for disaster\
(Yr 06)
...
Science - Year 6
Year 6 Achievement Standard []{.mark}
...
They describe and predict the effect of environmental changes on individual living things. Students explain how scientific knowledge helps us to solve problems and inform decisions and identify historical and cultural contributions.
...
**Assessment name: Explaining changes to the surface of Earth**
Students identify how research can improve data.
...
Specific monitoring opportunities in this unit may include observation, consultation and samples of student work.
Monitoring activities
**Activity name: Examining the effects of earthquakes** (Lesson 2)
Activity description: Students list evidence that may indicate an earthquake has taken place, discuss the use of a seismograph as a device to collect data about an earthquake, explain how knowledge of earthquake activity can be used by communities and describe changes to Earth\'s surface that are caused by earthquakes.
**Activity name: Using Asian indigenous knowledge to prepare for disaster** (Lesson 5)
Activity description: Students explain how stories told in different cultures allow for knowledge of natural disasters to be shared and describe how these stories improve the community\'s preparedness for natural disasters.
**Activity name: Analysing evidence using the Beaufort wind scale** (Lesson 13)
Activity description: Students explain that wind speed cannot always be measured directly, but can be determined by the effects of the wind, identify and examine the use of the Beaufort wind scale to report wind speeds and explore how only the maximum wind speed can be recorded after the event, but images taken during the event can indicate the wind speed at different stages of the event and identify limitations of the Beaufort wind scale.
Feedback
Feedback may relate to misunderstandings and common alternative conceptions. In this unit this may include students thinking:
- \'dormant\' and \'extinct\' are the same. Explain to students that extinct volcanoes are not likely to ever become active, whereas dormant volcanoes are inactive and may erupt again.
- \'lava\' and \'magma\' are the same. Explain to students that magma is molten rock beneath the surface and that lava is magma which has reached the surface.
- landslides are only caused by earthquakes. Explain that landslides can be caused by other factors (e.g. heavy rainfall).
- data from an earthquake can only be gathered during the actual event. Explain to students that data is collected during and after an earthquake. Information about earthquakes that have occurred in the past can be used to predict the future effects of earthquakes.
- nothing can be done to minimise the impact of a natural disaster. Explain to students that, although little can be done to prevent a natural disaster, steps can be taken to reduce the impact it has on human life and property.
- stories of earthquakes indicate a high frequency of earthquakes in that area. Explain to students that past events may indicate the potential for future earthquakes, but not their frequency.
- tropical cyclones, hurricanes, typhoons and tornadoes are the same things. Explain to students that hurricanes, typhoons and cyclones are different names for the same kind of weather system in different hemispheres. Explain to students that tropical cyclones are much larger and last longer than tornadoes. Tornadoes typically form over land, while tropical cyclones form over water.
...
- only the interior of Australia suffers drought conditions. Explain that many areas of Earth experience below average rainfall and that they can also experience drought.
- drought can be lifted after a few short periods of rainfall. Explain to students that the end point of a drought can only be determined after a long period of average rainfall has occurred.
- weather conditions are simple to predict. Explain to students that the prediction of weather conditions is a complicated skill that requires knowledge of patterns and interpretation of data gathered from a wide range of sources.
- wind speeds can only be measured directly. Explain to students that wind speeds can be measured by comparing the effect that the wind has on Earth\'s surface, with an established scale.
- only recent significant weather events are recorded and tracked. Explain to students that significant weather events, including tropical cyclones, have been tracked for many years. The data gathered from these past events can be used for predicting future events.
- that in an extreme weather event there is little that can be done to prevent disaster. Explain to students that preparations, if given enough time, can minimise the impact of many extreme weather events.
- that the issuing of a disaster alert guarantees that the disaster will occur. Explain to students that a disaster alert is issued as a precaution and that an alert does not always mean a disaster is inevitable.
...
5 Lessons
Geological events
- Lesson 1: Exploring volcanoes
- Lesson 2: Examining the effects of earthquakes
- Lesson 3: Exploring an earthquake in Australia
- Lesson 4: Exploring how people prepare for geological disaster
- Lesson 5: Using Asian indigenous knowledge to prepare for disaster
6 Lessons
Meteorological events
- Lessons 6-8: Investigating the formation of tropical cyclones
- Lesson 9: Examining the effects of ocean temperature
- Lesson 10: Using cultural knowledge to reduce the impact of drought
- Lesson 11: Interpreting rainfall data for droughts
3 Lessons
Weather measurement
- Lesson 12: Comparing the measuring scales of weather events
- Lesson 13: Analysing evidence using the Beaufort wind scale
- Lesson 14: Analysing the use of weather data in making predictions
2 Lessons
Preparation for weather events
- Lesson 15: Researching significant weather events in Australia
- Lesson 16: Identifying preparation for extreme weather events
2 Lessons
Assessment
- Lessons 17-18: Assessing student learning
2 Lessons
Forecasting and warnings
- Lessons 19-20: Researching technologies for weather forecasting and warning
20 Lessons
Total Unit
...
- Supporting learning resource - [Natural disasters: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_NaturalDisasters.docx)
- Understand why volcanic eruptions may or may not be natural disasters.
- Supporting learning resource - [Volcanoes: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_Volcanoes.docx)

---

## Evidence of learning

- Sheet - [Volcanoes](Resources/Documents/Sci_Y06_U3_SH_Volcanoes.docx)
Can the student:
- Video - [Mount St. Helens](Resources/Video/Sci_Y06_U3_MountStHelens.mp4) (PBS LearningMedia I © 2006 Idaho Public Television)
- Identify different kinds of natural disasters?
...
- Identify where volcanic eruptions are natural disasters?
...
- Define natural disasters
- Video - *Volcanoes 101* (National Geographic) http://video.nationalgeographic.com/video/101-videos/volcanoes-101
- Introduce volcanoes and define dormant, active and extinct volcanoes
- Website - *About volcanoes* (Australian Institute for Disaster Resilience) https://emschools.org.au/volcano/about-volcanos
- Explore volcanic eruptions and their effects
...
Examining the effects of earthquakes
Students will:
- Video - [Earthquakes](Resources/Video/Sci_Y06_U3_Earthquakes.mp4) (PBS LearningMedia I © 2011 Idaho Public Television)
- Understand the effects of earthquakes on Earth\'s surface and communities.
- Supporting learning resource - [Earthquakes: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_Earthquakes.docx)

---

## Evidence of learning

- Sheet - [Earthquakes](Resources/Documents/Sci_Y06_U3_SH_Earthquakes.docx)
Can the student:
- Sheet - [Notable earthquakes](Resources/Documents/Sci_Y06_U3_SH_NotableEarthquakes.docx)
- Identify changes to Earth\'s surface due to earthquakes?
- Video - [The Padang, Indonesia earthquake of 2009 Part 1](Resources/Video/Sci_Y06_U3_indonesia_earthquake_Part1.mp4) (US Geological Survey/ filmed & produced by Walter D. Mooney) http://gallery.usgs.gov/videos/283#.VmDKwHYrLBQ
- Explain why earthquakes can be considered natural disasters?
- Video - [The Padang, Indonesia earthquake of 2009 Part 2](Resources/Video/Sci_Y06_U3_indonesia_earthquake_Part2.mp4) (US Geological Survey/ filmed & produced by Walter D. Mooney) http://gallery.usgs.gov/videos/283#.VmDKwHYrLBQ
...
- Video - *Earthquakes 101* (National Geographic) http://video.nationalgeographic.com/video/environment/environment-natural-disasters/earthquakes/earthquake-101/
- List earthquakes in Australia in the recent past
...
- Explore the effects of earthquakes and landslides on Earth\'s surface
...
Students will:
- Sheet - [Earthquakes in the Newcastle area](Resources/Documents/Sci_Y06_U3_SH_Newcastle.docx)
- Understand evidence can be collected about an earthquake from a range of sources.
- Video - [Earthquake memories](Resources/Video/Sci_Y06_U3_EarthquakeMemories.mp4)
...
- Website - *Earthquakes* (Australian Government, Geoscience Australia) http://www.ga.gov.au/scientific-topics/hazards/earthquake
- Describe how Australia\'s First People\'s knowledge of natural disasters assists in scientific research?
- Video - *Newcastle Earthquake 1989 - NBN TV News Australia \[file 1\]* (YouTube, NewcastleMuseum) https://www.youtube.com/watch?v=RAtJMu14j8s

---

## Example learning sequence

- Video - *Newcastle Earthquake 1989 - NBN TV News Australia \[file 2\]* (YouTube, NewcastleMuseum) https://www.youtube.com/watch?v=pk8esCto9c4
- Explore the Newcastle earthquake and its effects
...
Students will:
- Supporting learning resource - [How people prepare for natural disasters: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_PrepareNatDisaster.docx)
- Understand how people prepare for natural disasters.
- Sheet - [Disaster preparation](Resources/Documents/Sci_Y06_U3_SH_DisasterPrep.docx)

---

## Evidence of learning

- Video - Earthquakes (PBS LearningMedia I © 2011 Idaho Public Television) (watch from 3:04 to 4:00)
Can the student:
- Sheet - [Summary of tables explaining the JMA seismic intensity scale](Resources/Documents/Sci_Y06_U3_SH_JMASiesmic.pdf) (Japan Meteorological Agency)
- Explain how people prepare for earthquakes or volcanic eruptions?
- Supporting learning resource - [Earthquakes: Be prepared](Resources/Documents/Sci_Y06_U3_SLR_EarthquakesBePrepared.pdf) © Commonwealth of Australia (Australian Emergency Management Institute) CC BY 3.0 http://creativecommons.org/licenses/by/3.0/
...
- Review effects of damage from natural disasters
- Video - *Alaska residents prepare for possible eruption* (YouTube, Associated Press) http://www.youtube.com/watch?feature=player_popout&v=rqZoNClTSRs
...
Using Asian indigenous knowledge to prepare for disaster
Students will:
...
6 Lessons
Overview
This series of lessons provides an opportunity for students to explore natural disasters that are caused by the weather and consider the impact these have on communities.
Spend a short time at the start of each lesson revising concepts, facts or skills and enhancing understanding and fluency.
End each lesson with a review of student learning in that lesson.
Lessons
Teaching and Learning Sequence
...
- Video - [Eye spy](Resources/Video/Sci_Y06_U3_eyespy.mp4) (Emergency Management Queensland, Queensland Fire and Emergency Services) CC BY 4.0 http://creativecommons.org/licenses/by/4.0/deed.en
...
Examining the effects of ocean temperature
Students will:
- Supporting learning resource - [Examining the effects of ocean temperature:\
Teacher note](Resources/Documents/Sci_Y06_U3_SLR_EffectsOceanTemp.docx)
- Understand the effects of convection currents in the atmosphere.
- Slideshow - [Onshore and offshore breezes](Resources/Documents/Sci_Y06_U3_SS_Onshoreandoffshorebreezes.pptx)
- Understand how thermographs are used.
- Sheet - [Onshore, offshore breeze](Resources/Documents/Sci_Y06_U3_SH_Onshore.docx)

---

## Evidence of learning

- Sheet - [Interpret a thermograph](Resources/Documents/Sci_Y06_U3_SH_InterpretTherm.docx)
Can the student:
- Sheet - [The sea and our weather](Resources/Documents/Sci_Y06_U3_SH_TheSea.docx)
- Explain how convection currents in the atmosphere cause winds?

---

## Helpful information

- Relate thermographs to ocean currents and weather?
...
Using cultural knowledge to reduce the impact of drought
Students will:
- Video - [Earth system: Drought and air quality](Resources/Video/Sci_Y06_U3_EarthSystemDroughtandAirQuality.mp4) (PBS LearningMedia, © 2006 WGBH Educational Foundation / NASA / Goddard Space Flight Centre)
- Understand how drought can affect Earth\'s surface.
- Supporting learning resource - [Impacts of drought on people and the surface of Earth: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_Drought.docx)
- Understand that methods for reducing the impact of drought can be found in a range of cultures.
- Sheet - [Impacts of droughts](Resources/Documents/Sci_Y06_U3_SH_Droughts.docx)

---

## Evidence of learning

- Supporting learning resource - [Indigenous knowledge for drought mitigation: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_InKnowlDroughtMit.docx)
Can the student:
- Sheet - [Indigenous knowledge for drought mitigation](Resources/Documents/Sci_Y06_U3_SH_IndigKnowDrought.docx)
- Describe the effects of drought on Earth\'s surface?
- Sheet - [Extracts about China and Vietnam from: Indigenous knowledge for disaster risk reduction: Good practices and lessons learned from experiences in the Asia-Pacific region](Resources/Documents/Sci_Y06_U3_SH_ExtractChina.pdf) (UNISDR) http://www.unisdr.org/files/3646_IndigenousKnowledgeDRR.pdf (Reprinted with the permission of the United Nations.)
- Describe how different techniques for drought mitigation from around the world can be used in Australia?
...
- Website - *Drought* (Australian Government, Bureau of Meteorology) http://www.bom.gov.au/climate/drought/
- Review natural disasters
- Website - *Can we \'drought-proof\' Australia?* (National Museum Australia) http://www.nma.gov.au/education/resources/units_of_work/drought
- Explore how drought affects people
...
Students will:
- Supporting learning resource - [Weather patterns for drought: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_WeatherPattern.docx)
- Use data to identify periods of drought experienced in different regions.
- Slideshow - [Drought: Interpreting rainfall data](Resources/Documents/Sci_Y06_U3_SS_Drought.pptx)

---

## Evidence of learning

- Sheet - [Interpreting rainfall data for droughts](Resources/Documents/Sci_Y06_U3_SH_RainfallData.docx)
Can the student:
...
- Website - *Climate glossary* (Australian Government, Bureau of Meteorology) http://www.bom.gov.au/climate/glossary/drought.shtml
...
3 Lessons
Overview
Throughout this lesson series, students will use different instruments and methods for recording weather data.
Spend a short time at the start of each lesson revising concepts, facts or skills and enhancing understanding and fluency.
End each lesson with a review of student learning in that lesson.
Lessons
Teaching and Learning Sequence
...
- Supporting learning resource - [Weather measurement - Teacher note](Resources/Documents/Sci_Y06_U3_SLR_WeatherMeasure.docx)
- Understand that weather data is used to predict weather events.
- Sheet - [Weather instrument: An anemometer](Resources/Documents/Sci_Y06_U3_SH_Anemometer.docx)

---

## Evidence of learning

- Sheet - [Weather instrument: A barometer](Resources/Documents/Sci_Y06_U3_SH_Barometer.docx)
Can the student:
- Slideshow - [Measuring weather](Resources/Documents/Sci_Y06_U3_SS_MeasuringWeather.pptx)
- Explain how weather data can be collected?
- Sheet - [Construct a barometer](Resources/Documents/Sci_Y06_U3_SH_ConstructBarom.docx)
- Identify data used to make predictions?
- Sheet - [Construct an anemometer](Resources/Documents/Sci_Y06_U3_SH_ConstructAnemom.docx)
...
- Identify instruments used to record and report weather conditions
...
- Construct an anemometer and a barometer
...
Students will:
- Supporting learning resource - [Beaufort wind scale: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_BeaufortScale.docx)
- Use the Beaufort wind scale to identify wind speed.
- Video - [Beaufort scale](Resources/Video/Sci_Y06_U3_BeaufortScale.mp4) (Curiosity Show - Deane Hutton & Rob Morrison) https://www.youtube.com/watch?v=rvPlImMELh8 Used with permission.
- Understand that the Beaufort wind scale has limitations.
- Sheet - [Beaufort wind scale](Resources/Documents/Sci_Y06_U3_SH_BeaufWindScale.docx)

---

## Evidence of learning

- Sheet - [Beaufort wind scale: Activity](Resources/Documents/Sci_Y06_U3_SH_BeaufortWindAct.docx)
Can the student:
- Slideshow - [Beaufort wind scale evidence](Resources/Documents/Sci_Y06_U3_SS_BeaufortWindEvid.pptx)
- Draw conclusions based on evidence using the Beaufort wind scale?
- Video - [A windy day](Resources/Video/Sci_Y6_U3_ILM16_Dig_WindyDay.mp4)
- Identify the limitations of the Beaufort wind scale?
- Video - [Cyclone Larry wind gusts](Resources/Video/Sci_Y06_U3_CycloneLArryWindGusts.mp4) Courtesy of K Maccoll. Used with permission.
...
Students will:
- Supporting learning resource - [Features of synoptic charts: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_FeatSynopChart.docx)
...
- Sheet - [Features of synoptic charts](Resources/Documents/Sci_Y06_U3_SH_FeatSynopChart.docx)

---

## Evidence of learning

- Sheet - [Synoptic chart worksheet](Resources/Documents/Sci_Y06_U3_SH_SynopChart.docx)
Can the student:
...
- Relate weather conditions to high and low pressure?
- Website - *Bureau of Meteorology* (Australian Government, Bureau of Meteorology) http://www.bom.gov.au
- Interpret information on a synoptic chart?
- Video - *Win News Wide Bay weather & closer* *(16/11/2009)* (YouTube, MackayTV2) http://www.youtube.com/watch?v=HPvwEnAZr40&feature=related

---

## Example learning sequence

- Website - *Australian weather* (Weatherzone) www.weatherzone.com.au
...
2 Lessons
Overview
Throughout this lesson series, students will require ready access to ICT at a whole-class, small-group and individual level. Students will investigate preparation methods that can be taken before a natural disaster.
Spend a short time at the start of each lesson revising concepts, facts or skills and enhancing understanding and fluency.
End each lesson with a review of student learning in that lesson.
Lessons
Teaching and Learning Sequence
...
Students will:
- Supporting learning resource - [Researching significant weather events: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_ResearchSigWeath.docx)
- Understand the changes to Earth\'s surface caused by extreme weather events.
- Supporting learning resource - [The behaviour of Severe Tropical Cyclone Marcia](Resources/Documents/Sci_Y06_U3_SLR_BehavSTCMarcia.docx)

---

## Evidence of learning

- Sheet - [Severe Tropical Cyclone Marcia](Resources/Documents/Sci_Y06_U3_SH_STCMarcia.docx)
Can the student:
- Sheet - [Beaufort wind scale](Resources/Documents/Sci_Y06_U3_SH_BeaufWindScale.docx)
- Identify key data about extreme weather events?
- Supporting learning resource - [The behaviour of two significant weather events](Resources/Documents/Sci_Y06_U3_SLR_SigWeatherEvents.docx)
- Describe the effects of extreme weather events?
- Sheet - [Compare and contrast significant weather events](Resources/Documents/Sci_Y06_U3_SH_CompareWeathEvents.docx)
...
- Explore the behaviour of a recorded cyclone
- Website - *Severe weather events* (Australian Government, Bureau of Meteorology) http://reg.bom.gov.au/announcements/sevwx/
- Research significant weather events which have affected Australia in the last decade
...
Students will:
- Sheet - [Tracking the path of a cyclone](Resources/Documents/Sci_Y06_U3_SH_TrackCyclonePath.docx)
- Understand the benefits of mapping the progress of a tropical cyclone.
- Slideshow - [Standard emergency warning signal (SEWS)](Resources/Documents/Sci_Y06_U3_SS_StandardEmergencyWarningSignalSEWS.pptx)
- Explore safety preparation measures needed for an extreme weather event.
- Supporting learning resource - [Standard emergency warning signal and emergency plan: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_EmergWarningSignal.docx)

---

## Evidence of learning

- Sheet - [Cyclone tracking map](Resources/Documents/Sci_Y06_U3_SH_CycloneTracking.docx) (Emergency Management Queensland) CC BY-NC 3.0 http://creativecommons.org/licenses/by-nc/3.0/au/deed.en
Can the student:
- Sheet - [Cyclone tracking map questions](Resources/Documents/Sci_Y06_U3_SH_CycTrackMapQuest.docx)
- Explain why scientists record the progress of a tropical cyclone on a tracking map?

---

## Helpful information

- Describe precautions that should be taken to prepare for an extreme weather event?
...
- Website - *Tropical cyclones* (Australian Government, Bureau of Meteorology) http://www.bom.gov.au/cyclone/
- Track the path of a cyclone
- Website - *Be prepared* (RACQ Get Ready Queensland) https://getready.qld.gov.au/be-prepared/
- Identify safety measures during extreme weather events
- Website - *Prepare your emergency plan: Fact sheet 1* (Queensland Government) https://getready.qld.gov.au/wp-content/uploads/2016/09/01_Prepare_your_emergency_plan.pdf
- Identify items useful in an emergency kit
- Website - *ABC Emergency* (ABC) http://www.abc.net.au/news/2012-08-27/about-abc-emergency/4225628
...
2 Lessons
Overview
This topic provides the opportunity for students to assess their understanding of the content.
Lessons
Teaching and Learning Sequence
...
Sheet - [Earthquakes in the Newcastle area](Resources/Documents/Sci_Y06_U3_SH_Newcastle.docx)
✔
Sheet - [Extracts about China and Vietnam from: Indigenous knowledge for disaster risk reduction: Good practices and lessons learned from experiences in the Asia-Pacific region](Extracts%20about%20China%20and%20Vietnam%20from:%20Indigenous%20knowledge%20for%20disaster%20risk%20reduction:%20Good%20practices%20and%20lessons%20learned%20from%20experiences%20in%20the%20Asia-Pacific%20region) (UNISDR) http://www.unisdr.org/files/3646_IndigenousKnowledgeDRR.pdf (Reprinted with the permission of the United Nations.)
✔
Sheet - [Extracts from: Indigenous knowledge for disaster risk reduction: Good practices and lessons learned from experiences in the Asia-Pacific region](Resources/Documents/Sci_Y06_U3_SH_IndknowDisasterRed.pdf) (UNISDR) © 2008 United Nations. Reprinted with the permission of the United Nations. http://www.unisdr.org/files/3646_IndigenousKnowledgeDRR.pdf
✔
Sheet - [Features of synoptic charts](Resources/Documents/Sci_Y06_U3_SH_FeatSynopChart.docx)
...
Supporting learning resource - [Earthquakes: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_Earthquakes.docx)
✔
Supporting learning resource - [Examining the effects of ocean temperature: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_EffectsOceanTemp.docx)
✔
Supporting learning resource - [Features of synoptic charts: Teacher note](Resources/Documents/Sci_Y06_U3_SLR_FeatSynopChart.docx)
✔
Supporting learning resource - [Global disaster alert and coordination system (GDACS): Teacher note](Resources/Documents/Sci_Y06_U3_SLR_GDACS.docx)
...
Interpret data identifying where research could improve the data.
Communicate ideas and findings.
A
◄
Applies knowledge to make a reasoned prediction.
◄
Explains how science knowledge from other cultures contributes to our understanding of natural events.
◄
Justifies how additional data from research provides a more accurate prediction.
Communicates, using accurate scientific language and appropriate representations comprehensively.
B
◄
Links evidence of change to the type and severity of a natural event.
◄
Describes how contributions have led to scientific understanding of natural events.
◄
Accurately interprets data identifying examples of how research improves data.
...
◄
Identifies historical and cultural contributions.
◄
Interprets data identifying where research could improve data.
Communicates ideas and findings.
D
◄
Identifies a change to Earth\'s surface caused by a natural event.
◄
Identifies a problem that may result because of a natural disaster.
◄
Suggests additional possible data
Uses everyday language.
E
◄
States a change.
◄
States a contribution to science.
◄
States data.
