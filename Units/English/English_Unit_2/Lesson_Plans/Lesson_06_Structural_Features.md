# Week 2, Lesson 6: Structural Features of Informative Texts
...
I can explain how characteristic text structures support the purpose of an informative text. (AC9E5LA03, AC9E5LY03)

## 2. Success Criteria
- I can identify key structural features on a webpage (headings, timelines, fast facts).
- I can describe where these features are located and what they look like.
- I can explain **why** an author uses these specific features to help the reader understand the information.
...
### Part B: Structural Mapping — Core Task (20 mins)
- Distribute **Lesson_06_Handout_Core.docx** to the class.
- Instruct students to choose one Cyclone Archive sub-page (e.g., Cyclone Larry or Cyclone Tracy).
- Students complete the graphic organiser table:
  - Locate the feature.
  - Describe it (Where is it? What does it look like?).
...
**Reflect (10 mins):**
- Have students Pair-Share their completed handouts.
- Ask 2-3 pairs to share their explanation for *why* the Fast Facts box is useful.
- **Socratic Question:** "What if the author removed all headings and sidebars, and just wrote everything as paragraphs? How would that change your reading experience?"
