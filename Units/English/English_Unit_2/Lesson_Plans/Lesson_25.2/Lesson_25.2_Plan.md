...
- **Part A Practice Worksheet:** Students work independently on `Lesson_25.2_Worksheet.docx` (Part A Practice Sheet). The worksheet matches the questions of the official Part A Assessment.
  - *Questions 1–3*: Main ideas, facts, and supporting details.
...
### Support: Lucas (Y2 Pathway)
- **Focus:** Lucas practices identifying the basic structure of a website page (main title, headings, images, captions) and responding to simple questions using a scaffolded checklist and spelling bank (AC9E2LY03, AC9E2LA03).
- **Simplified Goals:**
...
- **Practice Sheet Review:** Collect `Lesson_25.2_Worksheet.docx` at the end of the lesson. Mark Questions 7, 8, and 9 to diagnose students who need targeted intervention on language and visual features prior to the formal assessment.

---

*Australian Curriculum Version 9. Australian spelling throughout. Metric measurements used where applicable. Compiled for Tarampa State School.*
