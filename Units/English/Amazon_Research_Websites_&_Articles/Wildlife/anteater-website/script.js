...
style.textContent = `
    ...
    body:not(.loaded)::before {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(135deg, #2c5530, #4a90e2);
        z-index: 9999;
        display: flex;
        align-items: center;
...
backToTop.style.cssText = `
    ...
    width: 50px;
    height: 50px;
    background: linear-gradient(135deg, #4a90e2, #2c5530);
    color: white;
    border: none;
    border-radius: 50%;
    cursor: pointer;
...
console.log('Amazon River Dolphin website loaded successfully! 🐬');
