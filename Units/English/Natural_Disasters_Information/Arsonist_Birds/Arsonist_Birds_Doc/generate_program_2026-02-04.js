...
const fileName = "5C_Class_Program_2026-02-04.docx";
    ...
    sections: [{
        children: [
            ...
            new Paragraph({
                alignment: AlignmentType.CENTER,
                spacing: { after: 400 },
                children: [new TextRun({ text: "Wednesday, 4th February 2026", size: 28, font: THEME.font })]
            }),
            ...
            new Table({
                ...
                rows: [
                    ...
                    createRow("10:10 am", "Mathematics Activities (1 hour)"),
                    createRow("11:10 am", "BREAK", true),
                    createRow("11:50 am", "English Comprehension & Structured Literacy"),
                    createRow("12:50 pm", "Spelling / Other"),
                    createRow("Lunch", "BREAK", true),
                    createRow("Afternoon", "Science (OneNote Lesson 3)")
                ]
            }),
