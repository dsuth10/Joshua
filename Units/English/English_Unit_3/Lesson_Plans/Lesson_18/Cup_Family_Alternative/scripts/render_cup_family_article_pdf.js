...
const inputPath = path.join(lessonDir, "Lesson_18_Cup_Family_Reading_Article.html");
const outputPath = path.join(lessonDir, "Lesson_18_Cup_Family_Reading_Article.pdf");
...
async function main() {
  ...
  try {
    ...
    if (audit.pageCount !== 2) throw new Error(`Expected two article pages, found ${audit.pageCount}.`);
