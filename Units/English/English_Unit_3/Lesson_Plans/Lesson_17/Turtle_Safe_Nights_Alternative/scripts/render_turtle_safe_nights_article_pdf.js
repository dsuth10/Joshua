...
const inputPath = path.join(lessonDir, "Lesson_17_Turtle_Safe_Nights_Reading_Article.html");
const outputPath = path.join(lessonDir, "Lesson_17_Turtle_Safe_Nights_Reading_Article.pdf");
